...
# address we ALREADY KNOW is a real, correctly-shaped curvature record (proven
# by safeframe_find.py against the exact HREK-derived byte layout) and asks
# "does anything else in the process hold a pointer to this record, or into
# it?" If Reach's HUD renderer caches a pointer to this record, or copies a
# sub-range of it into a separate structure, this catches that reference
# directly - a fundamentally different signal than guessing struct shapes or
# scanning for common values.
#
