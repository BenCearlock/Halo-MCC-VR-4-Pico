...
#
# Use this to find candidate locations for the CURRENT hud_size (or any other
# config value) without assuming which struct or field owns it - the opposite
# of every attempt tonight that started from a known struct shape and asked
# "does this change". This starts from the value and asks "where does this
# value live at all".
#
